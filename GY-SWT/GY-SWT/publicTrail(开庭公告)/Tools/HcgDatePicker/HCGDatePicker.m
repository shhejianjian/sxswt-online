...
- (void)selectDate:(NSDate *)date{
    [self selectRow: _todayIndexPath.section
        inComponent: YEAR
           animated: YES];
    [self pickerView:self didSelectRow:_todayIndexPath.section inComponent:YEAR];
    
    [self selectRow: _todayIndexPath.row
        inComponent: MONTH
           animated: YES];
    
    [self pickerView:self didSelectRow:_todayIndexPath.row inComponent:MONTH];
    if (self.datePickerMode != DatePickerYearMonthMode) {
        ...
        CGFloat day = [strDate floatValue] -1;
    ...
    if (self.datePickerMode == DatePickerHourMode) {
        ...
        NSString *strDate = [dateFormatter stringFromDate:[NSDate date]];
        CGFloat hour = [strDate floatValue];
